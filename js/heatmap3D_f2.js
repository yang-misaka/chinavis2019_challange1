var myChart_f2;
var is_init_f2 = 0;
var heatmap3D_Update_f2;
var startTime_f2;
function heatmap3D_f2(dayX){
    ...
    d3.csv(dayX_mainMaps[dayX], function (error, data) {
        ...
        if(is_init_f2 == 0){
            myChart_f2 = echarts.init(document.getElementById('heatmap3D_f2'));
            is_init_f2 = 1;
        }  
        ...
        startData = data.filter(function (d) { return d.second == startTime_f2 && d.floor == 2 });
        ...
        heatmap3D_Update_f2 = function () {

            curTime = document.getElementById('time').value;

            curData = data.filter(function (d) { return d.time == curTime && d.floor == 2 });
